...
local function InitTabs()
  ...
  if tab11 then
    ...
    addonTable.bigHealthframePlayerTextureDD, addonTable.bigHealthframePlayerTextureLbl = StyledDropdown(uc, "Texture", 435, -22, 115)
    ...
    addonTable.ufHealthTextDD, addonTable.ufHealthTextLbl = StyledDropdown(uc, "Health Text", 435, -77, 115)
    addonTable.ufHealthTextDD:SetOptions({
      {text = "Numeric Value", value = "NUMERIC"},
      {text = "Percentage", value = "PERCENT"},
      {text = "Both", value = "BOTH"},
      {text = "None", value = "NONE"},
    })
    addonTable.ufPowerTextDD, addonTable.ufPowerTextLbl = StyledDropdown(uc, "Power Text", 435, -132, 115)
    addonTable.ufPowerTextDD:SetOptions({
      {text = "Numeric Value", value = "NUMERIC"},
      {text = "Percentage", value = "PERCENT"},
      {text = "Both", value = "BOTH"},
      {text = "None", value = "NONE"},
    })
    addonTable.bigHealthframePlayerDisableGlowsCB = Checkbox(uc, "Disable Player Frame Glows", 15, -62)
    ...
    addonTable.ufBorderColorSwatch:SetBackdropColor(1, 1, 1, 1)
    ...
    addonTable.ufBigHBBossCB = Checkbox(uc, "Boss", 315, -245)

    Section(uc, "Player Overlay Tuning", -276)
    addonTable.ufBigHBPlayerHealthXSlider = Slider(uc, "Player Health X", 15, -301, -200, 200, 0, 1)
    addonTable.ufBigHBPlayerHealthYSlider = Slider(uc, "Player Health Y", 280, -301, -200, 200, 0, 1)
    addonTable.ufBigHBPlayerHealthWSlider = Slider(uc, "Player Health Width", 15, -356, -200, 200, 0, 1)
    addonTable.ufBigHBPlayerHealthHSlider = Slider(uc, "Player Health Height", 280, -356, -200, 200, 0, 1)
    addonTable.ufBigHBPlayerBgXSlider = Slider(uc, "Player BG X", 15, -411, -200, 200, 0, 1)
    addonTable.ufBigHBPlayerBgYSlider = Slider(uc, "Player BG Y", 280, -411, -200, 200, 0, 1)
    addonTable.ufBigHBPlayerBgWSlider = Slider(uc, "Player BG Width", 15, -466, -200, 200, 0, 1)
    addonTable.ufBigHBPlayerBgHSlider = Slider(uc, "Player BG Height", 280, -466, -200, 200, 0, 1)
    addonTable.ufBigHBPlayerBgBrightnessSlider = Slider(uc, "Player BG Brightness", 15, -521, 0.0, 2.0, 1.0, 0.05)

    Section(uc, "Others Overlay Tuning (Target/Focus/Boss)", -556)
    addonTable.ufBigHBOtherHealthXSlider = Slider(uc, "Others Health X", 15, -581, -200, 200, 0, 1)
    addonTable.ufBigHBOtherHealthYSlider = Slider(uc, "Others Health Y", 280, -581, -200, 200, 0, 1)
    addonTable.ufBigHBOtherHealthWSlider = Slider(uc, "Others Health Width", 15, -636, -200, 200, 0, 1)
    addonTable.ufBigHBOtherHealthHSlider = Slider(uc, "Others Health Height", 280, -636, -200, 200, 0, 1)
    addonTable.ufBigHBOtherBgXSlider = Slider(uc, "Others BG X", 15, -691, -200, 200, 0, 1)
    addonTable.ufBigHBOtherBgYSlider = Slider(uc, "Others BG Y", 280, -691, -200, 200, 0, 1)
    addonTable.ufBigHBOtherBgWSlider = Slider(uc, "Others BG Width", 15, -746, -200, 200, 0, 1)
    addonTable.ufBigHBOtherBgHSlider = Slider(uc, "Others BG Height", 280, -746, -200, 200, 0, 1)
    addonTable.ufBigHBOtherBgBrightnessSlider = Slider(uc, "Others BG Brightness", 15, -801, 0.0, 2.0, 1.0, 0.05)
  end
