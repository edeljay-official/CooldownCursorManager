...
local function UpdateAllControls()
  ...
  if addonTable.bigHealthframePlayerClassColorCB then
    addonTable.bigHealthframePlayerClassColorCB:SetChecked(profile.useBiggerPlayerHealthframeClassColor == true)
    addonTable.bigHealthframePlayerClassColorCB:SetEnabled(true)
    addonTable.bigHealthframePlayerClassColorCB:SetAlpha(1)
  end
  if addonTable.bigHealthframePlayerDisableGlowsCB then
    if ufBigEnabled then
      profile.useBiggerPlayerHealthframeDisableGlows = true
      addonTable.bigHealthframePlayerDisableGlowsCB:SetChecked(true)
      addonTable.bigHealthframePlayerDisableGlowsCB:SetEnabled(false)
      if addonTable.bigHealthframePlayerDisableGlowsCB.SetAlpha then
        addonTable.bigHealthframePlayerDisableGlowsCB:SetAlpha(0.5)
      end
    else
      addonTable.bigHealthframePlayerDisableGlowsCB:SetChecked(profile.useBiggerPlayerHealthframeDisableGlows == true)
      addonTable.bigHealthframePlayerDisableGlowsCB:SetEnabled(true)
      if addonTable.bigHealthframePlayerDisableGlowsCB.SetAlpha then
        addonTable.bigHealthframePlayerDisableGlowsCB:SetAlpha(1)
      end
    end
  end
  ...
  local bigHBOn = profile.ufBigHBEnabled == true
  ...
  if addonTable.ufBorderColorBtn then addonTable.ufBorderColorBtn:SetEnabled(bigHBOn or profile.useCustomBorderColor == true) end
  ...
  if addonTable.ufBigHBTargetNameColorSwatch then addonTable.ufBigHBTargetNameColorSwatch:SetBackdropColor(num(profile.ufBigHBTargetNameColorR, 1), num(profile.ufBigHBTargetNameColorG, 1), num(profile.ufBigHBTargetNameColorB, 1), 1) end
  if addonTable.ufBigHBTargetLevelColorSwatch then addonTable.ufBigHBTargetLevelColorSwatch:SetBackdropColor(num(profile.ufBigHBTargetLevelColorR, 1), num(profile.ufBigHBTargetLevelColorG, 1), num(profile.ufBigHBTargetLevelColorB, 1), 1) end
  ...
  local targetGroupEnabled = ufBigEnabled and ufBigTarget
  local focusGroupEnabled = ufBigEnabled and ufBigFocus
  ...
  ApplyUFBigSlider(addonTable.ufBigHBPlayerNameXSlider, num(profile.ufBigHBPlayerNameX, 0), playerGroupEnabled)
  ApplyUFBigSlider(addonTable.ufBigHBPlayerNameYSlider, num(profile.ufBigHBPlayerNameY, 0), playerGroupEnabled)
  ApplyUFBigSlider(addonTable.ufBigHBPlayerLevelXSlider, num(profile.ufBigHBPlayerLevelX, 0), playerGroupEnabled)
  ApplyUFBigSlider(addonTable.ufBigHBPlayerLevelYSlider, num(profile.ufBigHBPlayerLevelY, 0), playerGroupEnabled)
  ...
  ApplyUFBigSlider(addonTable.ufBigHBTargetNameXSlider, num(profile.ufBigHBTargetNameX, 0), targetGroupEnabled)
  ApplyUFBigSlider(addonTable.ufBigHBTargetNameYSlider, num(profile.ufBigHBTargetNameY, 0), targetGroupEnabled)
  ApplyUFBigSlider(addonTable.ufBigHBTargetLevelXSlider, num(profile.ufBigHBTargetLevelX, 0), targetGroupEnabled)
  ApplyUFBigSlider(addonTable.ufBigHBTargetLevelYSlider, num(profile.ufBigHBTargetLevelY, 0), targetGroupEnabled)
  ...
  ApplyUFBigSlider(addonTable.ufBigHBFocusNameXSlider, num(profile.ufBigHBFocusNameX, 0), focusGroupEnabled)
  ApplyUFBigSlider(addonTable.ufBigHBFocusNameYSlider, num(profile.ufBigHBFocusNameY, 0), focusGroupEnabled)
  ApplyUFBigSlider(addonTable.ufBigHBFocusLevelXSlider, num(profile.ufBigHBFocusLevelX, 0), focusGroupEnabled)
  ApplyUFBigSlider(addonTable.ufBigHBFocusLevelYSlider, num(profile.ufBigHBFocusLevelY, 0), focusGroupEnabled)
...
local function InitHandlers()
  ...
  if addonTable.ufBigHBEnableCB then addonTable.ufBigHBEnableCB.customOnClick = function(s) local p = GetProfile(); if p then p.ufBigHBEnabled = s:GetChecked(); if addonTable.useCustomBorderColorCB then local bigOn = s:GetChecked(); if bigOn then p.useCustomBorderColor = true; p.ufCustomBorderColorR = 0; p.ufCustomBorderColorG = 0; p.ufCustomBorderColorB = 0; addonTable.useCustomBorderColorCB:SetChecked(true); addonTable.useCustomBorderColorCB:SetEnabled(false); if addonTable.ufBorderColorBtn then addonTable.ufBorderColorBtn:SetEnabled(true) end; if addonTable.ufBorderColorSwatch then addonTable.ufBorderColorSwatch:SetBackdropColor(0, 0, 0, 1) end else addonTable.useCustomBorderColorCB:SetChecked(p.useCustomBorderColor == true); addonTable.useCustomBorderColorCB:SetEnabled(true); if addonTable.ufBorderColorBtn then addonTable.ufBorderColorBtn:SetEnabled(p.useCustomBorderColor == true) end end end; ApplyUFBigHealthbarChanges() end end end
  ...
  if addonTable.ufBigHBTargetNameColorBtn then
    addonTable.ufBigHBTargetNameColorBtn:SetScript("OnClick", function()
      local p = GetProfile()
      if not p then return end
      local r = p.ufBigHBTargetNameColorR or 1
      local g = p.ufBigHBTargetNameColorG or 1
      local b = p.ufBigHBTargetNameColorB or 1
      local function OnColorChanged()
        local nr, ng, nb = ColorPickerFrame:GetColorRGB()
        p.ufBigHBTargetNameColorR, p.ufBigHBTargetNameColorG, p.ufBigHBTargetNameColorB = nr, ng, nb
        if addonTable.ufBigHBTargetNameColorSwatch then addonTable.ufBigHBTargetNameColorSwatch:SetBackdropColor(nr, ng, nb, 1) end
        ApplyUFBigHealthbarChanges()
      end
      local function OnCancel(prev)
        p.ufBigHBTargetNameColorR, p.ufBigHBTargetNameColorG, p.ufBigHBTargetNameColorB = prev.r, prev.g, prev.b
        if addonTable.ufBigHBTargetNameColorSwatch then addonTable.ufBigHBTargetNameColorSwatch:SetBackdropColor(prev.r, prev.g, prev.b, 1) end
        ApplyUFBigHealthbarChanges()
      end
      ShowColorPicker({r = r, g = g, b = b, hasOpacity = false, swatchFunc = OnColorChanged, cancelFunc = OnCancel})
    end)
  end
  if addonTable.ufBigHBTargetLevelColorBtn then
    addonTable.ufBigHBTargetLevelColorBtn:SetScript("OnClick", function()
      local p = GetProfile()
      if not p then return end
      local r = p.ufBigHBTargetLevelColorR or 1
      local g = p.ufBigHBTargetLevelColorG or 1
      local b = p.ufBigHBTargetLevelColorB or 1
      local function OnColorChanged()
        local nr, ng, nb = ColorPickerFrame:GetColorRGB()
        p.ufBigHBTargetLevelColorR, p.ufBigHBTargetLevelColorG, p.ufBigHBTargetLevelColorB = nr, ng, nb
        if addonTable.ufBigHBTargetLevelColorSwatch then addonTable.ufBigHBTargetLevelColorSwatch:SetBackdropColor(nr, ng, nb, 1) end
        ApplyUFBigHealthbarChanges()
      end
      local function OnCancel(prev)
        p.ufBigHBTargetLevelColorR, p.ufBigHBTargetLevelColorG, p.ufBigHBTargetLevelColorB = prev.r, prev.g, prev.b
        if addonTable.ufBigHBTargetLevelColorSwatch then addonTable.ufBigHBTargetLevelColorSwatch:SetBackdropColor(prev.r, prev.g, prev.b, 1) end
        ApplyUFBigHealthbarChanges()
      end
      ShowColorPicker({r = r, g = g, b = b, hasOpacity = false, swatchFunc = OnColorChanged, cancelFunc = OnCancel})
    end)
  ...
  local exportCategoryKeys = {
    ...
    uf = {"enablePlayerDebuffs",
               ...
               "ufBigHBEnabled", "ufBigHBPlayerEnabled", "ufBigHBTargetEnabled", "ufBigHBFocusEnabled",
               ...
               "ufBigHBTargetNameColorR", "ufBigHBTargetNameColorG", "ufBigHBTargetNameColorB",
               "ufBigHBTargetLevelColorR", "ufBigHBTargetLevelColorG", "ufBigHBTargetLevelColorB"},
  }
  local keyToCategory = {}
