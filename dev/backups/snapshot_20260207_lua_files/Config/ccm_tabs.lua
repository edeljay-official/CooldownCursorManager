...
local function InitTabs()
  ...
  cur.showModeDD, cur.showModeLbl = StyledDropdown(tab2, "Show", 500, -32, 110)
  cur.showModeDD:SetOptions({{text = "Always", value = "always"}, {text = "Raid", value = "raid"}, {text = "Dungeon", value = "dungeon"}})
  ...
  local function CreateCustomBarTab(tabFrame, barNum, yOffset)
    ...
    cb.showModeDD, cb.showModeLbl = StyledDropdown(tabFrame, "Show", 550, -32, 110)
    cb.showModeDD:SetOptions({{text = "Always", value = "always"}, {text = "Raid", value = "raid"}, {text = "Dungeon", value = "dungeon"}})
  ...
  if tab11 then
    ...
    addonTable.bigHealthframePlayerClassColorCB = Checkbox(uc, "Use class color", 280, -37)
    addonTable.bigHealthframePlayerDisableGlowsCB = Checkbox(uc, "Disable Frame Glows", 15, -62)
    addonTable.bigHealthframePlayerDisableCombatTextCB = Checkbox(uc, "Disable Player Combat Text", 280, -62)
    ...
    addonTable.useCustomBorderColorCB = Checkbox(uc, "Custom Border Color", 15, -134)
    local ufBorderLbl = uc:CreateFontString(nil, "OVERLAY", "GameFontNormal")
    ufBorderLbl:SetPoint("TOPLEFT", uc, "TOPLEFT", 15, -159)
    ufBorderLbl:SetText("Border Color")
    addonTable.ufBorderColorBtn = CreateStyledButton(uc, "Border Color", 100, 22)
    addonTable.ufBorderColorBtn:SetPoint("TOPLEFT", uc, "TOPLEFT", 15, -184)
    ...
    addonTable.bigHealthframePlayerTextureDD, addonTable.bigHealthframePlayerTextureLbl = StyledDropdown(uc, "Texture", 280, -159, 115)
    addonTable.bigHealthframePlayerTextureDD:SetOptions(textureOptions)
    addonTable.bigHealthframePlayerTextureDD:SetEnabled(true)
    if addonTable.bigHealthframePlayerTextureLbl then
      addonTable.bigHealthframePlayerTextureLbl:SetTextColor(0.9, 0.9, 0.9)
    end

    Section(uc, "Use Bigger Healthbars", -220)
    addonTable.ufBigHBEnableCB = Checkbox(uc, "Enable", 15, -245)
    addonTable.ufBigHBPlayerCB = Checkbox(uc, "Player", 90, -245)
    addonTable.ufBigHBTargetCB = Checkbox(uc, "Target", 165, -245)
    addonTable.ufBigHBFocusCB = Checkbox(uc, "Focus", 240, -245)
    addonTable.ufBigHBTargetNameColorBtn = CreateStyledButton(uc, "Name Color", 100, 22)
    addonTable.ufBigHBTargetNameColorBtn:SetPoint("TOPLEFT", uc, "TOPLEFT", 15, -272)
    addonTable.ufBigHBTargetNameColorSwatch = CreateFrame("Frame", nil, uc, "BackdropTemplate")
    addonTable.ufBigHBTargetNameColorSwatch:SetSize(22, 22)
    addonTable.ufBigHBTargetNameColorSwatch:SetPoint("LEFT", addonTable.ufBigHBTargetNameColorBtn, "RIGHT", 4, 0)
    addonTable.ufBigHBTargetNameColorSwatch:SetBackdrop({bgFile = "Interface\\Buttons\\WHITE8x8", edgeFile = "Interface\\Buttons\\WHITE8x8", edgeSize = 1})
    addonTable.ufBigHBTargetNameColorSwatch:SetBackdropColor(1, 1, 1, 1)
    addonTable.ufBigHBTargetNameColorSwatch:SetBackdropBorderColor(0.3, 0.3, 0.35, 1)
    addonTable.ufBigHBTargetLevelColorBtn = CreateStyledButton(uc, "Level Color", 100, 22)
    addonTable.ufBigHBTargetLevelColorBtn:SetPoint("TOPLEFT", uc, "TOPLEFT", 240, -272)
    addonTable.ufBigHBTargetLevelColorSwatch = CreateFrame("Frame", nil, uc, "BackdropTemplate")
    addonTable.ufBigHBTargetLevelColorSwatch:SetSize(22, 22)
    addonTable.ufBigHBTargetLevelColorSwatch:SetPoint("LEFT", addonTable.ufBigHBTargetLevelColorBtn, "RIGHT", 4, 0)
    addonTable.ufBigHBTargetLevelColorSwatch:SetBackdrop({bgFile = "Interface\\Buttons\\WHITE8x8", edgeFile = "Interface\\Buttons\\WHITE8x8", edgeSize = 1})
    addonTable.ufBigHBTargetLevelColorSwatch:SetBackdropColor(1, 1, 1, 1)
    addonTable.ufBigHBTargetLevelColorSwatch:SetBackdropBorderColor(0.3, 0.3, 0.35, 1)

    Section(uc, "Player", -302)
    addonTable.ufBigHBHidePlayerNameCB = Checkbox(uc, "Hide Name", 15, -327)
    addonTable.ufBigHBHidePlayerLevelCB = Checkbox(uc, "Hide Level", 240, -327)
    addonTable.ufBigHBPlayerNameXSlider = Slider(uc, "Name X", 15, -357, -200, 200, 0, 1)
    addonTable.ufBigHBPlayerNameYSlider = Slider(uc, "Name Y", 280, -357, -200, 200, 0, 1)
    addonTable.ufBigHBPlayerLevelXSlider = Slider(uc, "Level X", 15, -412, -200, 200, 0, 1)
    addonTable.ufBigHBPlayerLevelYSlider = Slider(uc, "Level Y", 280, -412, -200, 200, 0, 1)

    Section(uc, "Target", -472)
    addonTable.ufBigHBHideTargetNameCB = Checkbox(uc, "Hide Name", 15, -497)
    addonTable.ufBigHBHideTargetLevelCB = Checkbox(uc, "Hide Level", 240, -497)
    addonTable.ufBigHBTargetNameXSlider = Slider(uc, "Name X", 15, -527, -200, 200, 0, 1)
    addonTable.ufBigHBTargetNameYSlider = Slider(uc, "Name Y", 280, -527, -200, 200, 0, 1)
    addonTable.ufBigHBTargetLevelXSlider = Slider(uc, "Level X", 15, -582, -200, 200, 0, 1)
    addonTable.ufBigHBTargetLevelYSlider = Slider(uc, "Level Y", 280, -582, -200, 200, 0, 1)

    Section(uc, "Focus", -642)
    addonTable.ufBigHBHideFocusNameCB = Checkbox(uc, "Hide Name", 15, -667)
    addonTable.ufBigHBHideFocusLevelCB = Checkbox(uc, "Hide Level", 240, -667)
    addonTable.ufBigHBFocusNameXSlider = Slider(uc, "Name X", 15, -697, -200, 200, 0, 1)
    addonTable.ufBigHBFocusNameYSlider = Slider(uc, "Name Y", 280, -697, -200, 200, 0, 1)
    addonTable.ufBigHBFocusLevelXSlider = Slider(uc, "Level X", 15, -752, -200, 200, 0, 1)
    addonTable.ufBigHBFocusLevelYSlider = Slider(uc, "Level Y", 280, -752, -200, 200, 0, 1)
  end
  ...
  if tab12 then
    ...
    Section(qc, "Useful Features", -823)
    addonTable.autoRepairCB = Checkbox(qc, "Auto Repair (Guild > Gold)", 15, -848)
    addonTable.showTooltipIDsCB = Checkbox(qc, "Show Spell/Item IDs in Tooltip", 280, -848)
    addonTable.compactMinimapIconsCB = Checkbox(qc, "Compact Minimap Icons", 15, -873)
    Section(qc, "Combat Timer", -903)
    addonTable.combatTimerCB = Checkbox(qc, "Enable Combat Timer", 15, -928)
    addonTable.combatTimerModeDD, addonTable.combatTimerModeLbl = StyledDropdown(qc, "Timer Visibility", 280, -963, 170)
    addonTable.combatTimerModeDD:SetOptions({
      {text = "Show Always", value = "always"},
      {text = "Only In Combat", value = "combat"},
    })
    addonTable.combatTimerStyleDD, addonTable.combatTimerStyleLbl = StyledDropdown(qc, "Timer Style", 15, -963, 170)
    addonTable.combatTimerStyleDD:SetOptions({
      {text = "Boxed", value = "boxed"},
      {text = "Minimal", value = "minimal"},
    })
    addonTable.combatTimerXSlider = Slider(qc, "X Offset", 15, -1038, -1500, 1500, 0, 1)
    addonTable.combatTimerYSlider = Slider(qc, "Y Offset", 280, -1038, -1500, 1500, 200, 1)
    addonTable.combatTimerCenteredCB = Checkbox(qc, "Center X", 15, -1098)
    addonTable.combatTimerScaleSlider = Slider(qc, "Scale", 15, -1158, 0.6, 2.0, 1.0, 0.05)
    addonTable.combatTimerTextColorBtn = CreateStyledButton(qc, "Text Color", 80, 22)
    addonTable.combatTimerTextColorBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 280, -1102)
    ...
    addonTable.combatTimerBgColorBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 280, -1162)
    ...
    Section(qc, "Timer for CR", -1245)
    addonTable.crTimerCB = Checkbox(qc, "Enable Timer for CR", 15, -1270)
    addonTable.crTimerModeDD, addonTable.crTimerModeLbl = StyledDropdown(qc, "Visibility", 15, -1305, 170)
    addonTable.crTimerModeDD:SetOptions({
      {text = "Show Always", value = "always"},
      {text = "Only In Combat", value = "combat"},
    })
    addonTable.crTimerLayoutDD, addonTable.crTimerLayoutLbl = StyledDropdown(qc, "Layout", 280, -1305, 170)
    addonTable.crTimerLayoutDD:SetOptions({
      {text = "Vertical", value = "vertical"},
      {text = "Horizontal", value = "horizontal"},
    })
    addonTable.crTimerXSlider = Slider(qc, "X Offset", 15, -1380, -1500, 1500, 0, 1)
    addonTable.crTimerYSlider = Slider(qc, "Y Offset", 280, -1380, -1500, 1500, 150, 1)
    addonTable.crTimerCenteredCB = Checkbox(qc, "Center X", 15, -1440)
    Section(qc, "Combat Status", -1495)
    addonTable.combatStatusCB = Checkbox(qc, "Enable Combat Status", 15, -1520)
    addonTable.combatStatusPreviewOnBtn = CreateStyledButton(qc, "Show Preview", 90, 22)
    addonTable.combatStatusPreviewOnBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 280, -1524)
    ...
    addonTable.combatStatusXSlider = Slider(qc, "X Offset", 15, -1595, -1500, 1500, 0, 1)
    addonTable.combatStatusYSlider = Slider(qc, "Y Offset", 280, -1595, -1500, 1500, 280, 1)
    addonTable.combatStatusCenteredCB = Checkbox(qc, "Center X", 15, -1655)
    addonTable.combatStatusEnterColorBtn = CreateStyledButton(qc, "Enter Color", 90, 22)
    addonTable.combatStatusEnterColorBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 280, -1659)
    ...
    addonTable.combatStatusScaleSlider = Slider(qc, "Scale", 15, -1715, 0.6, 2.0, 1.0, 0.05)
    addonTable.combatStatusLeaveColorBtn = CreateStyledButton(qc, "Leave Color", 90, 22)
    addonTable.combatStatusLeaveColorBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 280, -1719)
