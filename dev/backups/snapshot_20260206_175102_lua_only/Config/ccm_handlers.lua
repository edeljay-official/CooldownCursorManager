...
local function UpdateAllControls()
  ...
  if addonTable.bigHealthframePlayerDisableGlowsCB then
    ...
    local enableGlows = (profile.useBiggerPlayerHealthframe == true) or (profile.useBiggerPlayerHealthframeClassColor == true)
  ...
  if addonTable.bigHealthframePlayerDisableCombatTextCB then
    ...
    local enableCT = (profile.useBiggerPlayerHealthframe == true) or (profile.useBiggerPlayerHealthframeClassColor == true)
...
local function InitHandlers()
  ...
  if addonTable.bigHealthframePlayerCB then
    addonTable.bigHealthframePlayerCB.customOnClick = function(s)
      ...
      if addonTable.bigHealthframePlayerDisableGlowsCB then
        local allow = enabled or p.useBiggerPlayerHealthframeClassColor == true
        addonTable.bigHealthframePlayerDisableGlowsCB:SetEnabled(allow)
        addonTable.bigHealthframePlayerDisableGlowsCB:SetAlpha(allow and 1 or 0.5)
      end
      if addonTable.bigHealthframePlayerDisableCombatTextCB then
        local allow = enabled or p.useBiggerPlayerHealthframeClassColor == true
        addonTable.bigHealthframePlayerDisableCombatTextCB:SetEnabled(allow)
        addonTable.bigHealthframePlayerDisableCombatTextCB:SetAlpha(allow and 1 or 0.5)
      end
      if addonTable.ApplyUnitFrameCustomization then addonTable.ApplyUnitFrameCustomization() end
    end
  end
  if addonTable.bigHealthframePlayerClassColorCB then addonTable.bigHealthframePlayerClassColorCB.customOnClick = function(s) local p = GetProfile(); if p then p.useBiggerPlayerHealthframeClassColor = s:GetChecked(); if addonTable.bigHealthframePlayerDisableGlowsCB then local allow = (p.useBiggerPlayerHealthframe == true) or (p.useBiggerPlayerHealthframeClassColor == true); addonTable.bigHealthframePlayerDisableGlowsCB:SetEnabled(allow); addonTable.bigHealthframePlayerDisableGlowsCB:SetAlpha(allow and 1 or 0.5) end; if addonTable.bigHealthframePlayerDisableCombatTextCB then local allow = (p.useBiggerPlayerHealthframe == true) or (p.useBiggerPlayerHealthframeClassColor == true); addonTable.bigHealthframePlayerDisableCombatTextCB:SetEnabled(allow); addonTable.bigHealthframePlayerDisableCombatTextCB:SetAlpha(allow and 1 or 0.5) end; if addonTable.ApplyUnitFrameCustomization then addonTable.ApplyUnitFrameCustomization() end end end end
  if addonTable.bigHealthframePlayerDisableGlowsCB then
