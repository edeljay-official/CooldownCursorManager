...
local function InitTabs()
  ...
  if tab11 then
    ...
    addonTable.bigHealthframePlayerTextureDD, addonTable.bigHealthframePlayerTextureLbl = StyledDropdown(uc, "Health Texture", 435, -22, 115)
    ...
    ufBorderLbl:SetPoint("TOPLEFT", uc, "TOPLEFT", 15, -104)
    ufBorderLbl:SetText("Border Color")
    addonTable.ufBorderColorBtn = CreateStyledButton(uc, "Border Color", 100, 22)
    addonTable.ufBorderColorBtn:SetPoint("TOPLEFT", uc, "TOPLEFT", 15, -129)
