...
exportImportPopup:SetFrameStrata("FULLSCREEN_DIALOG")
...
generalAlwaysLbl:SetText("|cff888888General, Custom Bar and\nUnit Frame Customization\nare always included.\nNote: Tracked Spells/Items\nare not exported.|r")
...
selectAllBtn:SetPoint("TOPLEFT", exportImportPopup, "TOPLEFT", 20, -172)
...
reloadPopup:SetFrameStrata("FULLSCREEN_DIALOG")
...
examplePopup:SetFrameStrata("FULLSCREEN_DIALOG")
...
local function CreateTab(idx, txt, w)
  ...
  t:SetScript("OnClick", function()
    if activeTab ~= idx then
      ...
      Upd()
      if idx == 8 and addonTable.ShowCastbarPreview then
