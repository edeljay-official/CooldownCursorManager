...
local function InitTabs()
  ...
  if tab11 then
    ...
    addonTable.ufBigHBPlayerLevelDD = StyledDropdown(uc, nil, 240, -267, 130)
    ...
    addonTable.ufBigHBPlayerAbsorbStripesCB = Checkbox(uc, "Absorb Stripes", 490, -315)
    ...
    addonTable.ufBigHBTargetLevelDD = StyledDropdown(uc, nil, 240, -527, 130)
    ...
    addonTable.ufBigHBTargetAbsorbStripesCB = Checkbox(uc, "Absorb Stripes", 490, -575)
    ...
    addonTable.ufBigHBFocusLevelDD = StyledDropdown(uc, nil, 240, -787, 130)
    ...
    addonTable.ufBigHBFocusAbsorbStripesCB = Checkbox(uc, "Absorb Stripes", 490, -835)
  ...
  if tab12 then
    ...
    qolScrollChild:SetSize(490, 3550)
    ...
    addonTable.autoQuestExcludeCompletedCB = Checkbox(qc, "Exclude Completed", 195, -1153)
    addonTable.autoQuestRewardDD, addonTable.autoQuestRewardLbl = StyledDropdown(qc, "Multi-Reward", 35, -1178, 150)
    ...
    addonTable.combatTimerXSlider = Slider(qc, "X Offset", 15, -1368, -1500, 1500, 0, 1)
    addonTable.combatTimerYSlider = Slider(qc, "Y Offset", 280, -1368, -1500, 1500, 200, 1)
    addonTable.combatTimerCenteredCB = Checkbox(qc, "Center X", 15, -1428)
    addonTable.combatTimerScaleSlider = Slider(qc, "Scale", 15, -1488, 0.2, 2.0, 1.0, 0.05)
    addonTable.combatTimerTextColorBtn = CreateStyledButton(qc, "Text Color", 80, 22)
    addonTable.combatTimerTextColorBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 280, -1432)
    ...
    addonTable.combatTimerBgColorBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 280, -1492)
    ...
    Section(qc, "Timer for CR", -1575)
    addonTable.crTimerCB = Checkbox(qc, "Enable Timer for CR", 15, -1600)
    addonTable.crTimerModeDD, addonTable.crTimerModeLbl = StyledDropdown(qc, "Visibility", 15, -1635, 170)
    addonTable.crTimerModeDD:SetOptions({
      {text = "Show Always", value = "always"},
      {text = "Only In Combat", value = "combat"},
    })
    addonTable.crTimerLayoutDD, addonTable.crTimerLayoutLbl = StyledDropdown(qc, "Layout", 280, -1635, 170)
    addonTable.crTimerLayoutDD:SetOptions({
      {text = "Vertical", value = "vertical"},
      {text = "Horizontal", value = "horizontal"},
    })
    addonTable.crTimerDisplayDD, addonTable.crTimerDisplayLbl = StyledDropdown(qc, "Display", 15, -1675, 170)
    addonTable.crTimerDisplayDD:SetOptions({
      {text = "Charges + Timer", value = "timer"},
      {text = "Charges Only", value = "count"},
    })
    addonTable.crTimerXSlider = Slider(qc, "X Offset", 15, -1750, -1500, 1500, 0, 1)
    addonTable.crTimerYSlider = Slider(qc, "Y Offset", 280, -1750, -1500, 1500, 150, 1)
    addonTable.crTimerScaleSlider = Slider(qc, "Scale", 15, -1810, 0.2, 2.0, 1.0, 0.05)
    addonTable.crTimerCenteredCB = Checkbox(qc, "Center X", 15, -1870)
    Section(qc, "Combat Status", -1925)
    addonTable.combatStatusCB = Checkbox(qc, "Enable Combat Status", 15, -1950)
    addonTable.combatStatusPreviewOnBtn = CreateStyledButton(qc, "Show Preview", 90, 22)
    addonTable.combatStatusPreviewOnBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 280, -1954)
    ...
    addonTable.combatStatusXSlider = Slider(qc, "X Offset", 15, -2025, -1500, 1500, 0, 1)
    addonTable.combatStatusYSlider = Slider(qc, "Y Offset", 280, -2025, -1500, 1500, 280, 1)
    addonTable.combatStatusCenteredCB = Checkbox(qc, "Center X", 15, -2085)
    addonTable.combatStatusEnterColorBtn = CreateStyledButton(qc, "Enter Color", 90, 22)
    addonTable.combatStatusEnterColorBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 280, -2089)
    ...
    addonTable.combatStatusScaleSlider = Slider(qc, "Scale", 15, -2145, 0.6, 2.0, 1.0, 0.05)
    addonTable.combatStatusLeaveColorBtn = CreateStyledButton(qc, "Leave Color", 90, 22)
    addonTable.combatStatusLeaveColorBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 280, -2149)
    ...
    Section(qc, "Character Panel Enhancement", -2205)
    addonTable.betterItemLevelCB = Checkbox(qc, "Better Item Level (2 Decimals)", 15, -2230)
    addonTable.showEquipDetailsCB = Checkbox(qc, "Show Equipment Details", 280, -2230)
    Section(qc, "Chat Enhancement", -2270)

    addonTable.chatClassColorCB = Checkbox(qc, "Class-Colored Names", 15, -2295)
    addonTable.chatEditBoxStyledCB = Checkbox(qc, "Style Edit Box", 280, -2295)
    addonTable.chatUrlDetectionCB = Checkbox(qc, "Clickable URLs", 15, -2325)
    addonTable.chatHideButtonsCB = Checkbox(qc, "Hide Chat Buttons", 280, -2325)
    addonTable.chatTabFlashCB = Checkbox(qc, "Disable Tab Flash", 15, -2355)

    addonTable.chatTimestampsCB = Checkbox(qc, "Timestamps", 15, -2400)
    addonTable.chatTimestampFormatDD, addonTable.chatTimestampFormatLbl = StyledDropdown(qc, "Format", 35, -2425, 150)
    addonTable.chatTimestampFormatDD:SetOptions({{text = "HH:MM", value = "HH:MM"}, {text = "HH:MM:SS", value = "HH:MM:SS"}, {text = "12h AM/PM", value = "12h"}})
    addonTable.chatCopyButtonCB = Checkbox(qc, "Copy Chat Button", 280, -2400)
    addonTable.chatCopyButtonCornerDD, addonTable.chatCopyButtonCornerLbl = StyledDropdown(qc, "Corner", 300, -2425, 150)
    ...
    addonTable.chatBackgroundCB = Checkbox(qc, "Custom Chat Background", 15, -2495)
    addonTable.chatBgAlphaSlider = Slider(qc, "Background Opacity", 35, -2525, 0, 100, 40, 5)
    addonTable.chatBgColorBtn = CreateStyledButton(qc, "BG Color", 80, 22)
    addonTable.chatBgColorBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 300, -2539)
    ...
    addonTable.chatFadeToggleCB = Checkbox(qc, "Custom Chat Fading", 15, -2595)
    addonTable.chatFadeDelaySlider = Slider(qc, "Fade Delay (sec)", 35, -2625, 5, 120, 20, 5)

    addonTable.chatEditBoxDD, addonTable.chatEditBoxLbl = StyledDropdown(qc, "Edit Box Position", 15, -2700, 150)
    addonTable.chatEditBoxDD:SetOptions({{text = "Bottom", value = "bottom"}, {text = "Top", value = "top"}})
    addonTable.chatHideTabsDD, addonTable.chatHideTabsLbl = StyledDropdown(qc, "Chat Tabs", 280, -2700, 150)
    addonTable.chatHideTabsDD:SetOptions({{text = "Show", value = "off"}, {text = "Hide", value = "hide"}, {text = "Mouseover", value = "mouseover"}})

    Section(qc, "Skyriding Enhancement", -2770)

    addonTable.skyridingEnabledCB = Checkbox(qc, "Enable Skyriding UI", 15, -2795)
    addonTable.skyridingHideBlizzardCB = Checkbox(qc, "Hide Blizzard Vigor", 200, -2795)
    addonTable.skyridingHideCDMCB = Checkbox(qc, "Hide CDM / Bars", 400, -2795)

    addonTable.skyridingVigorBarCB = Checkbox(qc, "Vigor Bar", 15, -2840)
    addonTable.skyridingVigorColorBtn = CreateStyledButton(qc, "Vigor Color", 80, 22)
    addonTable.skyridingVigorColorBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 130, -2839)
    addonTable.skyridingVigorColorSwatch = CreateFrame("Frame", nil, qc, "BackdropTemplate")
    addonTable.skyridingVigorColorSwatch:SetSize(22, 22)
    addonTable.skyridingVigorColorSwatch:SetPoint("LEFT", addonTable.skyridingVigorColorBtn, "RIGHT", 4, 0)
    addonTable.skyridingVigorColorSwatch:SetBackdrop({bgFile = "Interface\\Buttons\\WHITE8x8", edgeFile = "Interface\\Buttons\\WHITE8x8", edgeSize = 1})
    addonTable.skyridingVigorColorSwatch:SetBackdropColor(0.2, 0.8, 0.2, 1)
    addonTable.skyridingVigorColorSwatch:SetBackdropBorderColor(0.3, 0.3, 0.35, 1)
    addonTable.skyridingEmptyColorBtn = CreateStyledButton(qc, "BG Color", 65, 22)
    addonTable.skyridingEmptyColorBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 250, -2839)
    addonTable.skyridingEmptyColorSwatch = CreateFrame("Frame", nil, qc, "BackdropTemplate")
    addonTable.skyridingEmptyColorSwatch:SetSize(22, 22)
    addonTable.skyridingEmptyColorSwatch:SetPoint("LEFT", addonTable.skyridingEmptyColorBtn, "RIGHT", 4, 0)
    addonTable.skyridingEmptyColorSwatch:SetBackdrop({bgFile = "Interface\\Buttons\\WHITE8x8", edgeFile = "Interface\\Buttons\\WHITE8x8", edgeSize = 1})
    addonTable.skyridingEmptyColorSwatch:SetBackdropColor(0.15, 0.15, 0.15, 1)
    addonTable.skyridingEmptyColorSwatch:SetBackdropBorderColor(0.3, 0.3, 0.35, 1)
    addonTable.skyridingRechargeColorBtn = CreateStyledButton(qc, "Recharge Color", 100, 22)
    addonTable.skyridingRechargeColorBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 355, -2839)
    addonTable.skyridingRechargeColorSwatch = CreateFrame("Frame", nil, qc, "BackdropTemplate")
    addonTable.skyridingRechargeColorSwatch:SetSize(22, 22)
    addonTable.skyridingRechargeColorSwatch:SetPoint("LEFT", addonTable.skyridingRechargeColorBtn, "RIGHT", 4, 0)
    addonTable.skyridingRechargeColorSwatch:SetBackdrop({bgFile = "Interface\\Buttons\\WHITE8x8", edgeFile = "Interface\\Buttons\\WHITE8x8", edgeSize = 1})
    addonTable.skyridingRechargeColorSwatch:SetBackdropColor(0.85, 0.65, 0.1, 1)
    addonTable.skyridingRechargeColorSwatch:SetBackdropBorderColor(0.3, 0.3, 0.35, 1)

    addonTable.skyridingSpeedDisplayCB = Checkbox(qc, "Speed Display", 15, -2880)
    addonTable.skyridingSpeedBarCB = Checkbox(qc, "Speed Bar", 155, -2880)
    addonTable.skyridingSpeedColorBtn = CreateStyledButton(qc, "Speed Color", 85, 22)
    addonTable.skyridingSpeedColorBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 270, -2879)
    addonTable.skyridingSpeedColorSwatch = CreateFrame("Frame", nil, qc, "BackdropTemplate")
    addonTable.skyridingSpeedColorSwatch:SetSize(22, 22)
    addonTable.skyridingSpeedColorSwatch:SetPoint("LEFT", addonTable.skyridingSpeedColorBtn, "RIGHT", 4, 0)
    addonTable.skyridingSpeedColorSwatch:SetBackdrop({bgFile = "Interface\\Buttons\\WHITE8x8", edgeFile = "Interface\\Buttons\\WHITE8x8", edgeSize = 1})
    addonTable.skyridingSpeedColorSwatch:SetBackdropColor(0.3, 0.6, 1.0, 1)
    addonTable.skyridingSpeedColorSwatch:SetBackdropBorderColor(0.3, 0.3, 0.35, 1)
    addonTable.skyridingSpeedUnitDD, addonTable.skyridingSpeedUnitLbl = StyledDropdown(qc, "Speed Unit", 400, -2870, 130)
    addonTable.skyridingSpeedUnitDD:SetOptions({{text = "Percent", value = "percent"}, {text = "Yards/s", value = "yds"}})

    addonTable.skyridingCooldownsCB = Checkbox(qc, "Ability Cooldowns", 15, -2925)
    addonTable.skyridingCooldownSizeSlider = Slider(qc, "Icon Size", 185, -2925, 16, 48, 28, 2)
    addonTable.skyridingCooldownPosDD, addonTable.skyridingCooldownPosLbl = StyledDropdown(qc, "Icon Position", 445, -2925, 100)
    addonTable.skyridingCooldownPosDD:SetOptions({{text = "Below", value = "below"}, {text = "Above", value = "above"}, {text = "Left", value = "left"}, {text = "Right", value = "right"}})

    addonTable.skyridingScaleSlider = Slider(qc, "Scale", 15, -3005, 50, 200, 100, 5)
    addonTable.skyridingCenteredCB = Checkbox(qc, "Center", 280, -3005)
    addonTable.skyridingPreviewOnBtn = CreateStyledButton(qc, "Show Preview", 90, 22)
    addonTable.skyridingPreviewOnBtn:SetPoint("TOPLEFT", qc, "TOPLEFT", 370, -3020)
    ...
    addonTable.skyridingXSlider = Slider(qc, "X Position", 15, -3065, -800, 800, 0, 5)
    addonTable.skyridingYSlider = Slider(qc, "Y Position", 280, -3065, -800, 800, -200, 5)
  end
end
